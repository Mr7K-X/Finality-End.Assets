...
function onCreate()
    makeLuaSprite('plate', 'bgsongs/emp/plate', -2150, -1350);
    setScrollFactor('plate', 1, 1);
    scaleObject('plate', 0.8, 0.8);

    makeLuaSprite('deadbody', 'bgsongs/emp/deadbody', -1400, -300);
    setScrollFactor('deadbody', 1, 1);
    scaleObject('deadbody', 1.50, 1.50);

    makeLuaSprite('screenofdeath', 'bgsongs/emp/screenofdeath', -1050, -300);
    setScrollFactor('screenofdeath', 1, 1);
    scaleObject('screenofdeath', 1.5, 1.5);

    makeAnimatedLuaSprite('glitch', 'bgsongs/emp/glitch', -2100, -350);
